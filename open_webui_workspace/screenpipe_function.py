...
class Pipe():
    ...
    class Valves(BaseModel):
        ...
        GET_RESPONSE: bool = Field(
            default=CONFIG.get_response, description="Whether to get a response from the pipe"
        )
        RESPONSE_MODEL: str = Field(
            default=CONFIG.response_model, description="Model to use for response"
        )
        LLM_API_BASE_URL: str = Field(
            default=CONFIG.llm_api_base_url, description="Base URL for the OpenAI API"
        )
        LLM_API_KEY: str = Field(
            default=CONFIG.llm_api_key, description="API key for the OpenAI API"
        )
