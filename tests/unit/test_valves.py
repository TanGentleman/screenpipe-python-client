import os
from src.core.core_pipe import Pipe as ScreenPipe
from src.core.core_filter import Filter as ScreenFilter
...
def test_filter(prompt: str = DEFAULT_PROMPT, stream: bool = True):
    filter = ScreenFilter()
    pipe = ScreenPipe()
